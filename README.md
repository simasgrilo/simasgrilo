...
I call myself Erick Grilo, 29 years old and working as a developer (officially) now for seven years. I specialize in enterprise software development, mainly in the ABAP Stack and as well as extensive knowledge in business process considering asset mainenance and finance/controlling. I also hold SAP certifications for ABAP Backend development in Cloud environment (C_ABAPD), Enterprise architecture (P_SAPEA) and as a CPI developer (C_CPI).

Although I currently specialize in SAP stack, I also have experience and work with other languages/stack, mainly Python (Flask, FastAPI, etc), and JavaScript (besides SAPUI5, Node.JS with Express), and Java. I always like to learn new languages/frameworks, especially when their model suits more the domain of the problem that I am working on / studying, and I see no problems in adapting my skillset according with the problem I currently need to solve. I am lucky enough to work with what I like.

I always aim to deliver clean and efficient solutions, having to deal with legacy architectural decisions with systems running millions of BRL and USD (depending on the company) on a daily basis, with emphasis on clean development principles (for both code and architecture).
...
**Tools**: Docker, Git, HANA, PostgreSQL, Figma
